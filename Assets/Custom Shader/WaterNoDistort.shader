		...
		*/
		...
		Pass	
		{
			...
			float4 frag(vertexOutput input) : COLOR
			{
				...
				float foamLine = clamp(1 - saturate(_DepthFactor * (depth - input.screenPos.w)), 0.05, 0.95);//1 - saturate(_DepthFactor * (depth - input.screenPos.w));
